 ...
 *
 * Exported so any other module that calls into the same sandbox (e.g.
 * lib/scenarioBooks.js's activateScenario) can reuse this exact wrapping instead of
 * duplicating it, and shares the one `config.callFunctionTimeoutMs` knob above.
