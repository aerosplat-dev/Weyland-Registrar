...
function setView(view) {
    ...
    // No back button for 'loading' either -- there's no prior real view to
    // return to yet, and the list/detail/form it would try to re-render
    // against is exactly the not-yet-ready state this view exists for.
    portalElement.querySelector('#wreg-back-btn').style.display = view === 'list' || view === 'loading' ? 'none' : '';
}
