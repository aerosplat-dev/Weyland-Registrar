...
// Reserved in BOTH the character book (uids 5000-7999) and the location book
// (uids 8000+) -- safely below either range, so it can never collide with a
// roster/location-list/character/location entry in either book. See
// bookOwnership.js for what actually lives at this uid.
export const MARKER_UID = 1;
